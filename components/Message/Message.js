        ...
        <div className={`grid grid-cols-[30px_1fr] gap-5 p-5 ${role === 'assistant' ? "bg-gray-500" : ""}`} > 
            <div> 
               ...
               /*  <Image src={user.picture} width={30} height={30} alt='User avatar'
                 ...
                 <div className="flex h-[30px] w-[30px] items-center justify-center rounded-sm shadow-md shadow-black " >
                    <FontAwesomeIcon icon={faUser} />
                 </div>
                )}
                {role === "assistant" && 
                  (
                    <div className="flex h-[30px] w-[30px] items-center justify-center rounded-sm shadow-md shadow-black bg-gray-700" >
